...
const PlaceOrder = () => {
      ...
      switch (method) {
        ...
        case "stripe":
          ...
          if (responseStripe.data.success) {
            ...
            console.log(stripe); // Check if the stripe object is defined
            console.log(stripe.paymentIntents);
          } // Ensure paymentIntents is accessible
          break;
        default:
          break;
      }
  ...
  return (
    <form
      ...
      className="flex flex-col sm:flex-row justify-bewteen gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t"
    >
      {/* LEFT SIDE */}
